    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#0F172A] to-[#1E293B] p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Reconnect to your Nexalink</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-slate-400">
            New to Nexalink?{" "}
            <Link href="/signup" className="text-[#4F46E5] hover:text-[#4338CA] underline-offset-4 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
